...
@section('content')
    <div class="container-fluid pt-5" id="cart-content">
        @if(isset($cartData))
                        ...
                        @if(Cookie::get('cart'))
                            ...
                            <tbody class="align-middle">
                                @foreach ($cartData as $item)
                                    <tr class="cart-item">
                                        <td class="align-middle"><img src="{{ asset('vendor/frontends/theme/img/product-1.jpg') }}" alt="" style="width: 50px;">{{ $item['name'] }}</td>
